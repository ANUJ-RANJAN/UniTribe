...
function AuthModal({ isOpen, onClose, onAuthSuccess }) {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-start justify-center" style={{ backgroundColor: 'rgba(0, 0, 0, 0.5)' }}>
      <div 
        className="bg-white rounded-lg shadow-lg w-96 max-w-md p-6 mt-24 m-2"
        style={{
          maxWidth: '90%'
        }}
      >
